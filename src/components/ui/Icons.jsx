...
export const CyberHazeIcon = ({ size = 16, className = "" }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className={className}>
    {/* Edges */}
    <path d="M13 2 L21 6 L16 8 Z" />
    <path d="M13 2 L5 6 L16 8" />
    <path d="M5 6 L10 12 L16 8" />
    <path d="M5 6 L5 18 L10 12" />
    <path d="M5 18 L13 22 L10 12" />
    <path d="M13 22 L16 16 L10 12" />
    <path d="M13 22 L21 18 L16 16 Z" />
    {/* Nodes */}
